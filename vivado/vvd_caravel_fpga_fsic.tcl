...
#
# Generated by Vivado on Fri Oct 27 11:44:19 CST 2023
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_net -net AXIS_SWz_0_as_aa_tdata [get_bd_pins AXIS_SWz_0/as_aa_tdata] [get_bd_pins aa_wrapper_0/as_aa_tdata]
  connect_bd_net -net AXIS_SWz_0_as_aa_tkeep [get_bd_pins AXIS_SWz_0/as_aa_tkeep] [get_bd_pins aa_wrapper_0/as_aa_tkeep]
  connect_bd_net -net AXIS_SWz_0_as_aa_tlast [get_bd_pins AXIS_SWz_0/as_aa_tlast] [get_bd_pins aa_wrapper_0/as_aa_tlast]
  connect_bd_net -net AXIS_SWz_0_as_aa_tready [get_bd_pins AXIS_SWz_0/as_aa_tready] [get_bd_pins aa_wrapper_0/as_aa_tready]
  connect_bd_net -net AXIS_SWz_0_as_aa_tstrb [get_bd_pins AXIS_SWz_0/as_aa_tstrb] [get_bd_pins aa_wrapper_0/as_aa_tstrb]
  connect_bd_net -net AXIS_SWz_0_as_aa_tuser [get_bd_pins AXIS_SWz_0/as_aa_tuser] [get_bd_pins aa_wrapper_0/as_aa_tuser]
  connect_bd_net -net AXIS_SWz_0_as_aa_tvalid [get_bd_pins AXIS_SWz_0/as_aa_tvalid] [get_bd_pins aa_wrapper_0/as_aa_tvalid]
  connect_bd_net -net AXIS_SWz_0_as_is_tdata [get_bd_pins AXIS_SWz_0/as_is_tdata] [get_bd_pins IO_SERDESz_0/as_is_tdata]
  connect_bd_net -net AXIS_SWz_0_as_is_tid [get_bd_pins AXIS_SWz_0/as_is_tid] [get_bd_pins IO_SERDESz_0/as_is_tid]
  connect_bd_net -net AXIS_SWz_0_as_is_tkeep [get_bd_pins AXIS_SWz_0/as_is_tkeep] [get_bd_pins IO_SERDESz_0/as_is_tkeep]
  connect_bd_net -net AXIS_SWz_0_as_is_tlast [get_bd_pins AXIS_SWz_0/as_is_tlast] [get_bd_pins IO_SERDESz_0/as_is_tlast]
  connect_bd_net -net AXIS_SWz_0_as_is_tready [get_bd_pins AXIS_SWz_0/as_is_tready] [get_bd_pins IO_SERDESz_0/as_is_tready]
  connect_bd_net -net AXIS_SWz_0_as_is_tstrb [get_bd_pins AXIS_SWz_0/as_is_tstrb] [get_bd_pins IO_SERDESz_0/as_is_tstrb]
  connect_bd_net -net AXIS_SWz_0_as_is_tuser [get_bd_pins AXIS_SWz_0/as_is_tuser] [get_bd_pins IO_SERDESz_0/as_is_tuser]
  connect_bd_net -net AXIS_SWz_0_as_is_tvalid [get_bd_pins AXIS_SWz_0/as_is_tvalid] [get_bd_pins IO_SERDESz_0/as_is_tvalid]
  ...
  connect_bd_net -net IO_SERDESz_0_is_as_tdata [get_bd_pins AXIS_SWz_0/is_as_tdata] [get_bd_pins IO_SERDESz_0/is_as_tdata]
  connect_bd_net -net IO_SERDESz_0_is_as_tid [get_bd_pins AXIS_SWz_0/is_as_tid] [get_bd_pins IO_SERDESz_0/is_as_tid]
  connect_bd_net -net IO_SERDESz_0_is_as_tkeep [get_bd_pins AXIS_SWz_0/is_as_tkeep] [get_bd_pins IO_SERDESz_0/is_as_tkeep]
  connect_bd_net -net IO_SERDESz_0_is_as_tlast [get_bd_pins AXIS_SWz_0/is_as_tlast] [get_bd_pins IO_SERDESz_0/is_as_tlast]
  connect_bd_net -net IO_SERDESz_0_is_as_tready [get_bd_pins AXIS_SWz_0/is_as_tready] [get_bd_pins IO_SERDESz_0/is_as_tready]
  connect_bd_net -net IO_SERDESz_0_is_as_tstrb [get_bd_pins AXIS_SWz_0/is_as_tstrb] [get_bd_pins IO_SERDESz_0/is_as_tstrb]
  connect_bd_net -net IO_SERDESz_0_is_as_tuser [get_bd_pins AXIS_SWz_0/is_as_tuser] [get_bd_pins IO_SERDESz_0/is_as_tuser]
  connect_bd_net -net IO_SERDESz_0_is_as_tvalid [get_bd_pins AXIS_SWz_0/is_as_tvalid] [get_bd_pins IO_SERDESz_0/is_as_tvalid]
  ...
  connect_bd_net -net aa_wrapper_0_aa_as_tdata [get_bd_pins AXIS_SWz_0/aa_as_tdata] [get_bd_pins aa_wrapper_0/aa_as_tdata]
  connect_bd_net -net aa_wrapper_0_aa_as_tkeep [get_bd_pins AXIS_SWz_0/aa_as_tkeep] [get_bd_pins aa_wrapper_0/aa_as_tkeep]
  connect_bd_net -net aa_wrapper_0_aa_as_tlast [get_bd_pins AXIS_SWz_0/aa_as_tlast] [get_bd_pins aa_wrapper_0/aa_as_tlast]
  connect_bd_net -net aa_wrapper_0_aa_as_tready [get_bd_pins AXIS_SWz_0/aa_as_tready] [get_bd_pins aa_wrapper_0/aa_as_tready]
  connect_bd_net -net aa_wrapper_0_aa_as_tstrb [get_bd_pins AXIS_SWz_0/aa_as_tstrb] [get_bd_pins aa_wrapper_0/aa_as_tstrb]
  connect_bd_net -net aa_wrapper_0_aa_as_tuser [get_bd_pins AXIS_SWz_0/aa_as_tuser] [get_bd_pins aa_wrapper_0/aa_as_tuser]
  connect_bd_net -net aa_wrapper_0_aa_as_tvalid [get_bd_pins AXIS_SWz_0/aa_as_tvalid] [get_bd_pins aa_wrapper_0/aa_as_tvalid]
